...
namespace VPFrameworks.Http.Abstractions
{
    ...
    public class HttpLoggingHandler : DelegatingHandler
    {
        ...
        public HttpLoggingHandler(ILoggerProvider loggerProvider, HttpMessageHandler innerHandler)
            : base(innerHandler)
        {
            this.logger = loggerProvider.CreateLogger(nameof(HttpLoggingHandler));
