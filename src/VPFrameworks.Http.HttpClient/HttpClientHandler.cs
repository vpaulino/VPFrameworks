...
namespace VPFrameworks.Http.Abstractions
{
    ...
    public abstract class HttpClientHandler  
    {
        ...
        /// 
        /// </summary>
        public bool ExposeHttpInfo { get; set; }
        ...
        /// <summary>
        ///  Creates a new instance of HttpClientHandler
        /// </summary>
        ...
        protected HttpClientHandler(HttpClient httpClient, string appId, MediaTypeFormatter mediaTypeFormatter)
        {
            ...
            //  this.RegisterHandler(new AddDataToRequestHandler(this.AppId));

            this.ExposeHttpInfo = false;
        }
